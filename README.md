...
# https://www.boilstream.com/binaries/linux-aarch64/boilstream-0.7.10
# https://www.boilstream.com/binaries/linux-x64/boilstream-0.7.10
# https://www.boilstream.com/binaries/darwin-x64/boilstream-0.7.10
curl -L -o boilstream https://www.boilstream.com/binaries/darwin-aarch64/boilstream-0.7.10
...
# boilinginsights/boilstream:x64-linux-0.7.10 or boilinginsights/boilstream:aarch64-linux-0.7.10
docker run -v ./config.yaml:/app/config.yaml \
   -p 5432:5432 \
   -p 50250:50250 \
   -p 50051:50051 \
   -e SERVER_IP_ADDRESS=1.2.3.4 boilinginsights/boilstream:aarch64-linux-0.7.10
```
